      ...
      <div className="space-y-3">
        ...
        <div>
          ...
          <div className="flex gap-1 p-0.5 bg-[#2a2a2a] rounded-lg">
            <button
              type="button"
              className={`${STYLES.modeButton} ${device.showFrame !== false ? STYLES.modeButtonActive : STYLES.modeButtonInactive}`}
              onClick={() => onUpdateDevice({ showFrame: true })}
            >
              With Frame
            </button>
            <button
              type="button"
              className={`${STYLES.modeButton} ${device.showFrame === false ? STYLES.modeButtonActive : STYLES.modeButtonInactive}`}
              onClick={() => onUpdateDevice({ showFrame: false })}
            >
              No Frame
            </button>
          </div>
