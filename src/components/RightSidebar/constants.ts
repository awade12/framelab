...
export const STYLES = {
  ...
  /** Solid color swatch */
  solidColorButton: "h-6 w-full rounded-md border border-white/10 transition-transform hover:scale-105",

  /** Solid color swatch active */
  solidColorButtonActive: "ring-2 ring-white scale-105",
