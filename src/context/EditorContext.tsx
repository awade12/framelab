...
const normalizeScreenshot = (
  ...
  return {
    ...baseScreenshot,
    ...rest,
    backgroundImageSrc: screenshot.backgroundImageSrc ?? null,
    backgroundImageZoom: screenshot.backgroundImageZoom ?? 100,
    backgroundImageOffsetX: screenshot.backgroundImageOffsetX ?? 0,
    backgroundImageOffsetY: screenshot.backgroundImageOffsetY ?? 0,
...
export const EditorProvider = ({ children }: { children: ReactNode }) => {
  ...
  const addScreenshot = () => {
    const newScreenshot: Screenshot = {
      ...
      backgroundImageZoom: activeScreenshot.backgroundImageZoom,
      backgroundImageOffsetX: activeScreenshot.backgroundImageOffsetX,
      backgroundImageOffsetY: activeScreenshot.backgroundImageOffsetY,
      gradientPresetId: activeScreenshot.gradientPresetId,
      customGradient: activeScreenshot.customGradient ?? null,
